    ...
    <div className="">
      ...
      <div className="relative navbar z-20">
        <div className="grid grid-cols-6 pt-[38px]">
          <div className="pl-[137px]"><Image src="/assets/githubb.png" width={54} height={54} alt="Github Icon"></Image></div>
          <div className="col-span-4 flex space-x-[60px] items-center justify-center">  
            <Link href="" className="text-[26px]">Home</Link>
            <Link href="" className="text-[26px]">About</Link>
            <Link href="" className="text-[26px]">Project</Link>
            <Link href="" className="text-[26px]">Contact</Link>
          </div>  
          <div className=""><button><Image src="/assets/togle.png" width={54} height={54} alt="Toggle"></Image></button></div>
        </div>
      </div>
      <div className="relative introduce z-10">
        <div className="grid grid-cols-5">
          <div className="col-span-4 pt-[153px] pl-[137px] text-[120px] font-bold leading-none">Hello!</div>
          <div className=""></div>
        </div>
        <div className="grid grid-cols-6">
          <div className="col-span-6 pl-[142px] text-[56px]"><p className="flex pb-[40px] tracking-[13px]">I'm Muhammad Hardian <p className="text-[#EAF9FF] ml-[26px] font-semibold">Esa</p></p></div>
          <div className="">
            <CircularText
